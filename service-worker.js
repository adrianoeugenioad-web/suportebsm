const CACHE="adsb-v80-online-v1";
const ASSETS=["./","./index.html","./css/style.css","./js/app.js","./js/firebase-config.js","./manifest.json","./img/login-adsb.jpg","./icons/icon-192.png","./icons/icon-512.png"];
